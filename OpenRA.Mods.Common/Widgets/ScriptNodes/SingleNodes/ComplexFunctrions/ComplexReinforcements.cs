...
{
    public class ComplexReinforcementsWidget : SimpleNodeWidget
    {
        public ComplexReinforcementsWidget(NodeEditorNodeScreenWidget screen) : base(screen)
        {
            WidgetName = "Scripts: Reinforcements";
