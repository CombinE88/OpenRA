...
namespace OpenRA.Mods.Common.Widgets.ScriptNodes.SingleNodes.ActorNodes
{
    ...
    public class ActorCreateActorLogic : NodeLogic
    {
        ...
        public override void Execute(World world)
        {
            ...
            if (InConnections.First(c => c.ConTyp == ConnectionType.Player).In != null)
            ...
            var exeNodes = Insc.NodeLogics.Where(n => n.InConnections.FirstOrDefault(c => c.ConTyp == ConnectionType.Exec && c.In == OutConnections.First(o => o.ConTyp == ConnectionType.Exec)) != null);
